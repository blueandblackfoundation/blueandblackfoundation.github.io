...
$(function(){
r=function(){dpi=window.devicePixelRatio;var a='data-src';var e=document.querySelector('.js21');if(e.hasAttribute('src')){a='src';}e.setAttribute(a,(dpi>1)?'images/blue-and-black-foundation2-312.png':'images/blue-and-black-foundation2-156.png');
...
ldsrc('.js19');ldsrcset('.js22 source');ldsrc('.js20');ldsrcset('.js23 source');ldsrc('.js21');ldsrcset('.js24 source');
});