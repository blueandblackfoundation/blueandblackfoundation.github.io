...
function em1(){var c="bqqmzAcmvfboecmbdlgpvoebujpo/psh";var addr="mailto:";for(var i=0;i<c.length;i++)addr+=String.fromCharCode(c.charCodeAt(i)-1);window.location.href=addr;}
...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js29');e.setAttribute('src',(dpi>1)?'images/blue-and-black-foundation2-864.png':'images/blue-and-black-foundation2-432.png');

var e=document.querySelector('.js31');e.setAttribute('src',(dpi>1)?'images/blue-and-black-foundation2-422.png':'images/blue-and-black-foundation2-211.png');};
